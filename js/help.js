...
function HELP_CLASS() {
	...
	this.help_about = function () {
		var email = 'gmdianaty@deltaechovictor.cf';
		POP.add({title: "Name:", value: "miniPaint " + VERSION});
		POP.add({title: "Description:", value: 'An lightweight online image editor based on miniPaint'});
		POP.add({title: "Author:", value: 'ViliusL and Graham Dianaty'});
		POP.add({title: "Email:", html: '<a href="mailto:' + email + '">' + email + '</a>'});
		POP.add({title: "GitHub:", html: '<a href="https://github.com/vogasoftware/pixelshop">pixelshop on github</a>'});
		POP.show('About', '');
	};
